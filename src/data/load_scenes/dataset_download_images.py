...
def download(num, downloads_dir, decompress_dir):
    url = urls_to_download[num]
    ...
    # Decompress
    cmd = "unzip" + " -qq " + download_file + " -d " + decompress_dir
    ...
    return os.path.splitext(download_name)[0]


def urls_qty():
    return len(urls_to_download)
